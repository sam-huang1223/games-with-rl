...
##### *April 21, 2018*
* **Challenge #1**: Recursively populate game board - Goal: to allow for efficient implementation of heuristic evaluation (compared to old Connect4 implementation)
